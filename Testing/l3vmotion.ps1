...
.DESCRIPTION
    ...
    1. create a vmkernel portgorup, select your vSwitch with tcp ip stack as vmotion but with everything else as default (leave portgroup name, vlan, ip address, subnet mask as default or blank)
